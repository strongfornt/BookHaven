      ...
      <div className="hero bg-[#1313130D]  rounded-xl lg:min-h-[90vh]">
        <div className="hero-content flex-col  lg:flex-row-reverse gap-10">
          ...
          <div className="space-y-8">
            ...
            <NavLink to='/listedBooks' className="relative inline-flex items-center justify-start  border border-success px-3 py-2 lg:px-6 lg:py-3 cursor-pointer overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
